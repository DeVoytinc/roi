    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return TextButton(
                        onPressed: () {
                          indexSelectedRegion =
                              suggestons.indexOf(searchedSuggestion[index]);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
          ...
          //         style: ButtonStyle(
          //           shape:
          //               MaterialStatePropertyAll(const RoundedRectangleBorder(
          ...
          const Expanded(
            child: Padding(
              ...
              child: Center(
                child: Text(
                  'Проект работает на технологиях Российской общественной инициативы. Не является официальным приложением.',
                  textAlign: TextAlign.left,
                  style: TextStyle(
